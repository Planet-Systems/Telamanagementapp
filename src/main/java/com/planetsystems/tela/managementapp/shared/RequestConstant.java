...
public class RequestConstant {
	...
	public static final String GET_TIME_TABLE_LESSONS_FOR_STAFF_ACADEMIC_YEAR_TERM_DISTRICT_SCHOOL_DATE = "GET_TIME_TABLE_LESSONS_FOR_STAFF_ACADEMIC_YEAR_TERM_DISTRICT_SCHOOL_DATE";

	public static final String SAVE_STAFF_DAILY_ATTENDANCE_TASKS = "SAVE_STAFF_DAILY_ATTENDANCE_TASKS";
	public static final String GET_STAFF_DAILY_ATTENDANCE_TASK_SCHOOL_STAFF_DATE = "GET_STAFF_DAILY_ATTENDANCE_TASK_SCHOOL_STAFF_DATE";
	public static final String GET_STAFF_DAILY_ATTENDANCE_TASKS_FOR_STAFF_DATE_DAILY_ATTENDANCE = "GET_STAFF_DAILY_ATTENDANCE_TASKS_FOR_STAFF_DATE_DAILY_ATTENDANCE";
