...
public class RequestConstant {
	...
	public static final String GET_SCHOOL_CLASS_IN_SCHOOL_ACADEMIC = "GET_SCHOOL_CLASS_IN_SCHOOL_ACADEMIC";
	...
	public static final String SAVE_STAFF_DAILY_ATTENDANCE_TASKS = "SAVE_STAFF_DAILY_ATTENDANCE_TASKS";
	
	public static final String GET_STAFF_DAILY_ATTENDANCE_ACADEMIC_YEAR_TERM_DUSTRICT_SCHOOL_DATE = "GET_STAFF_DAILY_ATTENDANCE_ACADEMIC_YEAR_TERM_DUSTRICT_SCHOOL_DATE";
