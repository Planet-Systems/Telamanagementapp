...
public class NameTokens {
	...
	public static final String dailyattendacedashboard = "Daily Attendace Dashboard";
	...
	public static final String StaffDailyAttendanceSuperVision = "Time Attendance";
	...
	public static String getSchoolperformance() {
		return schoolperformance;
	}

	public static String getDistrictperformance() {
		return districtperformance;
	}

	public static String getNationalperformace() {
		return nationalperformace;
	}
