...
public class StaffDailyTaskPresenter
			...
			public void onTabSelected(TabSelectedEvent event) {
				...
				if (selectedTab.equalsIgnoreCase(StaffDailyTaskView.STAFF_DAILY_ATTENDANCES)) {
					...
					comboUtil.loadAcademicTermComboByAcademicYear(
							...
							getView().getStaffDailyAttendancePane().getAcademicTermCombo(), dispatcher, placeManager,
							null);
		...
		getView().getStaffDailyAttendancePane().getLoadAttendanceButton().addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				dispatcher.execute(new RequestAction(
						RequestConstant.GET_STAFF_DAILY_ATTENDANCE_ACADEMIC_YEAR_TERM_DUSTRICT_SCHOOL_DATE, map),
	...
	////////////////
	private void getTimeTableLessonsForStaffAcademicYearTermDistrictSchoolDay(
			final ViewStaffDailyAttendanceTaskPane viewStaffDailyAttendanceTaskPane, final String academicYearId,
			final String academicTermId, final String districtId, final String schoolId, final String schoolStaffId) {
		...
		view.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				if (getView().getStaffDailyAttendancePane().getStaffDailyAttendanceListGrid().anySelected()) {
					...
					getTimeTableLessonsForStaffAcademicYearTermDistrictSchoolDay(viewStaffDailyAttendanceTaskPane,
							academicYearId, academicTermId, districtId, schoolId, schoolStaffId);
