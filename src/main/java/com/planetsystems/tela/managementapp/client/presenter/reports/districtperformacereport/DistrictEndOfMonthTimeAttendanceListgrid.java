...
public class DistrictEndOfMonthTimeAttendanceListgrid extends SuperListGrid {
	...
	public DistrictEndOfMonthTimeAttendanceListgrid() {
		super();
	...
	public ListGridRecord addRowData(DistrictEndOfMonthTimeAttendanceDTO dto) {
	...
	public void addRecordsToGrid(List<DistrictEndOfMonthTimeAttendanceDTO> list) {
		ListGridRecord[] records = new ListGridRecord[list.size()];
		int row = 0;
		for (DistrictEndOfMonthTimeAttendanceDTO item : list) {
