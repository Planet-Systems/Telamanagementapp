...
public class SchoolEndOfWeekTimeAttendanceListgrid extends SuperListGrid {
	...
	public SchoolEndOfWeekTimeAttendanceListgrid() {
		super();
		...
		sun.setHidden(true);
		ListGridField total = new ListGridField(TOTAL, "Total Hours of Teachers on Site");
	...
	public ListGridRecord addRowData(SchoolEndOfWeekTimeAttendanceDTO dto) {
	...
	public void addRecordsToGrid(List<SchoolEndOfWeekTimeAttendanceDTO> list) {
		ListGridRecord[] records = new ListGridRecord[list.size()];
		int row = 0;
		for (SchoolEndOfWeekTimeAttendanceDTO item : list) {
