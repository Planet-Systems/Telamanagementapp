...
public class StaffDailyAttendanceSupervisionListGrid extends SuperListGrid {
	...
	public StaffDailyAttendanceSupervisionListGrid() {
		...
		ListGridField clockOutTimeField = new ListGridField(CLOCK_OUT_TIME, "Clockout Time");
		ListGridField commentField = new ListGridField(COMMENT, "Comment");

		ListGridField staffField = new ListGridField(SCHOOL_STAFF, "Teacher");
		...
		this.setFields(idField, staffIdField, supervisiordIdField, staffField, clockInTimeField, clockOutTimeField,
				supervisiorStatusField, supervisionDateField, supervisionTimeField, commentField, supervisiorField);
	...
	public ListGridRecord addRowData(StaffDailyAttendanceSupervisionDTO supervisionDTO) {
		...
		record.setAttribute(CLOCK_IN_TIME, supervisionDTO.getClockinTime());
		record.setAttribute(CLOCK_OUT_TIME, supervisionDTO.getClockoutTime()); 
		record.setAttribute(SUPERVISIOR_STATUS, supervisionDTO.getSupervisionStatus());
	...
	public static class StaffDailyAttendanceSupervisionDataSource extends DataSource {
		...
		public StaffDailyAttendanceSupervisionDataSource(String id) {
			...
			this.setFields(idField, staffIdField, supervisiordIdField, supervisiorField, staffField,
					supervisionDateField, supervisionTimeField, commentField);
