...
public class DailyAttendanceEnrollmentSummaryListgrid  extends SuperListGrid {
	...
	public DailyAttendanceEnrollmentSummaryListgrid() {
		...
		ListGridField enroledSchools = new ListGridField(ENROLED_SCHOOLS, "No. Schools Enrolled");
		ListGridField clockedSchools = new ListGridField(CLOCKED_SCHOOLS, "No. Schools Clocked-In");
		
		ListGridField enrolledTeachers = new ListGridField(ENROLED_TEACHERS, "No. Teachers Enrolled");
		ListGridField clockedInteachers = new ListGridField(CLOCKIN_TEACHERS, "No. Teachers Clocked-In");
		
		ListGridField enroledLearners = new ListGridField(ENROLED_LEARNERS, "No. Learners Enrolled");
		ListGridField clockedLearners = new ListGridField(CLOCKIN_LEARNERS, "No. Learners Attendance Recorded");
