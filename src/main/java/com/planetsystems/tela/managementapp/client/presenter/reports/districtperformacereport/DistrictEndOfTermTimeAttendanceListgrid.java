...
public class DistrictEndOfTermTimeAttendanceListgrid extends SuperListGrid {
	...
	public DistrictEndOfTermTimeAttendanceListgrid() {
		super();
		...
		this.setFields(school, month1, month2, month3, total, expected, balance, percent);

	}

	public ListGridRecord addRowData(DistrictEndOfTermTimeAttendanceDTO dto) {
	...
	public void addRecordsToGrid(List<DistrictEndOfTermTimeAttendanceDTO> list) {
		ListGridRecord[] records = new ListGridRecord[list.size()];
		int row = 0;
		for (DistrictEndOfTermTimeAttendanceDTO item : list) {
