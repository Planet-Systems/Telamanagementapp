...
public class NationalEndOfWeekTimeAttendanceListgrid extends SuperListGrid {
	...
	public NationalEndOfWeekTimeAttendanceListgrid() {
		super();
		...
		this.setFields(district, mon, tue, wed, thur, fri, sat, sun, total, expected, balance, percent);

	}

	public ListGridRecord addRowData(NationalEndOfWeekTimeAttendanceDTO dto) {
	...
	public void addRecordsToGrid(List<NationalEndOfWeekTimeAttendanceDTO> list) {
		ListGridRecord[] records = new ListGridRecord[list.size()];
		int row = 0;

		for (NationalEndOfWeekTimeAttendanceDTO item : list) {
