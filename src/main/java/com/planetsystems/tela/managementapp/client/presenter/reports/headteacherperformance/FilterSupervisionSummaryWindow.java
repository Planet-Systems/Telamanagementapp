...
public class FilterSupervisionSummaryWindow extends Window {
	...
	public FilterSupervisionSummaryWindow() {
		...
		fromDateItem.setTitle("Supervision Date");

		// toDateItem
		form.setFields(academicYearCombo, academicTermCombo, regionCombo, districtCombo, schoolCombo, fromDateItem);
		...
		this.setTitle("HeadTeacher Supervison Summary");
