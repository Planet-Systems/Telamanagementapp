...
public class LearnerRegistrationWindow extends Window {
	...
	public LearnerRegistrationWindow() {
		super();
		...
		dynamicForm.setFields(firstNameField, lastNameField, otherNameField, genderCombo, nationality,nationalIdField, dobItem,
				homeDistrict,  orphanStatusCombo, specialNeedsCombo, phoneNumberField,telaNoField,
				academicYearCombo, academicTermCombo,districtCombo,
				 schoolCombo,  schoolClassCombo);
		...
		buttonLayout2.setMembers(addButton);
		...
		guardianLayout.setMembers(buttonLayout2, listgrid);
