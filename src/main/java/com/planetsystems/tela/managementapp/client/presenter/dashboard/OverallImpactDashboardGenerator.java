...
public class OverallImpactDashboardGenerator {

	private static OverallImpactDashboardGenerator instance = new OverallImpactDashboardGenerator();

	private OverallImpactDashboardGenerator() {

	}

	public static OverallImpactDashboardGenerator getInstance() {
		return instance;
	}
	...
	private Chart learnersPerYearChart() {
		Chart lineChart = new Chart().setType(Series.Type.COLUMN)
				.setChartTitle(new ChartTitle().setText("Learner Enrollment by Year"))
	...
	private Chart learnersByYearByGenderStackedChart() {
		...
		final Chart chart = new Chart().setType(Series.Type.COLUMN)
				.setChartTitleText("Learner Enrollment by Year by Gender")
	...
	private Chart teachersPerYearChart() {
		Chart lineChart = new Chart().setType(Series.Type.COLUMN)
				.setChartTitle(new ChartTitle().setText("Teacher Enrollment by Year"))
	...
	private Chart teachersByYearByGenderStackedChart() {
		...
		final Chart chart = new Chart().setType(Series.Type.COLUMN)
				.setChartTitleText("Teacher Enrollment by Year by Gender")
				.setSeriesPlotOptions(new SeriesPlotOptions().setStacking(PlotOptions.Stacking.NORMAL))
				.setLegend(new Legend().setBackgroundColor("#FFFFFF").setReversed(true))
				.setToolTip(new ToolTip().setFormatter(new ToolTipFormatter() {
					public String format(ToolTipData toolTipData) {
