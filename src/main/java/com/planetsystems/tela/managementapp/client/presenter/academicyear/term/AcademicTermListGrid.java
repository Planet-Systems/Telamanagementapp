...
public class AcademicTermListGrid extends SuperListGrid {
	...
	public AcademicTermListGrid() {
		...
		ListGridField displayName = new ListGridField(DISPLAY_NAME, "Display Name");
		displayName.setHidden(true);
		
		ListGridField type = new ListGridField(TYPE, "Type");

		this.setDataSource(dataSource);

		this.setFields(idField, yearIdField, yearField, codeField, nameField, displayName, type, statusField,
	...
	public ListGridRecord addRowData(AcademicTermDTO academicTermDTO) {
		...
		record.setAttribute(DISPLAY_NAME, academicTermDTO.getDisplayName());
		record.setAttribute(TYPE, academicTermDTO.getAssessmentPeriodType());
	...
	public static class AcademicTermDataSource extends DataSource {
		...
		public AcademicTermDataSource(String id) {
			...
			this.setFields(idField, yearIdField, yearField, codeField, nameField, statusField, startDateField,
					endDateField);
