...
public class LearnerAttendanceListGrid extends SuperListGrid {
	...
	public LearnerAttendanceListGrid() {
		...
		ListGridField schoolStaffField = new ListGridField(SCHOOL_STAFF, "Submitted By");
		ListGridField schoolStaffIdField = new ListGridField(SCHOOL_STAFF_ID, "School Staff Id");
		schoolStaffIdField.setHidden(true);

		ListGridField attendanceDateField = new ListGridField(ATTENDANCE_DATE, "Date");
		ListGridField girlsAbsentField = new ListGridField(GIRLS_ABSENT, "No. Girls Absent");
		ListGridField boysAbsentField = new ListGridField(BOYS_ABSENT, "No. Boys Absent");
		ListGridField totalAbsentField = new ListGridField(TOTAL_ABSENT, "Total Absent");

		ListGridField girlsPresentField = new ListGridField(GIRLS_PRESENT, "No. Girls Present");
		ListGridField boysPresentField = new ListGridField(BOYS_PRESENT, "No. Boys Present");
		...
		this.setFields(idField, schoolClassIdField, academicTermField, schoolField,
				schoolStaffIdField,   attendanceDateField, schoolClassField,
				boysPresentField, girlsPresentField, totalPresentField, boysAbsentField, girlsAbsentField,
				totalAbsentField, commentField, schoolStaffField);
		...
		if (learnerAttendanceDTO.getAcademicTermDTO() != null) {
			...
			if (learnerAttendanceDTO.getAcademicTermDTO().getAcademicYearDTO() != null) {
				record.setAttribute(ACADEMIC_YEAR,
						learnerAttendanceDTO.getAcademicTermDTO().getAcademicYearDTO().getName());
				record.setAttribute(ACADEMIC_YEAR_ID,
						learnerAttendanceDTO.getAcademicTermDTO().getAcademicYearDTO().getId());
	...
	public static class LearnerAttendanceDatasource extends DataSource {
		...
		public LearnerAttendanceDatasource(String id) {
			...
			this.setFields(idField, schoolClassIdField, academicTermIdField, academicTermField, schoolField,
					schoolStaffIdField, academicTermField, schoolClassField, schoolStaffField, attendanceDateField,
					boysPresentField, girlsPresentField, totalPresentField, boysAbsentField, girlsAbsentField,
					totalAbsentField, commentField);
